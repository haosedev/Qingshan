        ...
        computed: {
            res1() {
                ...
                if (density > 0) {
                    ...
                    var result = density * parseInt(this.val_s) * (parseInt(this.val_d) - parseInt(this.val_s)) * parseInt(this.val_ll);
                    return result;
                } else {
                    return 0;
                }
            ...
            res2() {
                ...
                var density = this.numList[key_num];
                if (density > 0) {
                    var result = parseInt(this.val_ww) / (density * parseInt(this.val_s) * (parseInt(this.val_d) - parseInt(this.val_s)));
                    return result;
                } else {
                    return 0;
                }
