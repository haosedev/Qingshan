<template>
    <div>
        ...
        <group :title="title">
         ...
         <group :title="itemStr">
            <x-input title="*边宽(b)" v-model="val_b" type="number" keyboard="number" :show-clear="false"><div slot="right" mini>mm</div></x-input>
            <x-input title="*边厚(d)" v-model="val_d" type="number" keyboard="number" :show-clear="false"><div slot="right" mini>mm</div></x-input>
            <x-input title="*圆弧半径(rr)" v-model="val_rr" type="number" keyboard="number" :show-clear="false"><div slot="right" mini>mm</div></x-input>
        ...
        computed: {
            res1() {
                ...
                if (density > 0) {
                    ...
                    var result = density * (parseInt(this.val_d) * (2 * parseInt(this.val_b) - parseInt(this.val_d)) + 0.215 * (parseInt(this.val_rr) * parseInt(this.val_rr) - 2 * parseInt(this.val_r) * parseInt(this.val_r))) * parseInt(this.val_ll);
                    return result;
                } else {
                    return 0;
                }
            ...
            res2() {
                ...
                if (density > 0) {
                    ...
                    var result = parseInt(this.val_ww) / (density * (parseInt(this.val_d) * (2 * parseInt(this.val_b) - parseInt(this.val_d)) + 0.215 * (parseInt(this.val_rr) * parseInt(this.val_rr) - 2 * parseInt(this.val_r) * parseInt(this.val_r))));
                    return result;
                } else {
                    return 0;
                }
